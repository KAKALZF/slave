...
public class pic {
    ...
    private Font font = new Font("仿宋", Font.PLAIN, 20);// 添加字体的属性设置
...
//            g.setBackground(Color.WHITE);
    ...
    public static void main(String[] args) {
        ...
        BufferedImage d = tt.loadImageLocal("D:\\20180125000315.png");
        //      BufferedImage b = tt
        //              .loadImageLocal("E:\\文件(word,excel,pdf,ppt.txt)\\zte-logo.png");
        tt.modifyImage(d,"深圳",180,180);
        tt.modifyImage(d,"广州南",100,180);
        tt.writeImageLocal("D:\\cc.jpg",d
                //往图片上写文件
        );
